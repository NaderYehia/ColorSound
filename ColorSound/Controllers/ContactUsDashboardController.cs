...
{
    public class ContactUsDashboardController : Controller
    {
        private readonly ThemesShopDbContext _context;

        public ContactUsDashboardController(ThemesShopDbContext context)
        {
            _context = context;
        }

        // GET: ContactUsDashboard
        public async Task<IActionResult> Index()
        {
            return View(await _context.ContactUs.ToListAsync());
        }

        // GET: ContactUsDashboard/Details/5
        ...
        // GET: ContactUsDashboard/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ContactUsDashboard/Create
        ...
        // POST: ContactUsDashboard/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ContactUsDashboard/Delete/5
        ...
        // POST: ContactUsDashboard/Delete/5
