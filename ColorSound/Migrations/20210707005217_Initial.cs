    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorToAuthor", x => new { x.AuthorId, x.FollowerId });
                    table.ForeignKey(
                        name: "FK_AuthorToAuthor_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AuthorToAuthor_Authors_FollowerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorToAuthor_FollowerId",
